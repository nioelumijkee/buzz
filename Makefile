...
#------------------------------------------------------------------------------#
LIBRARY_NAME = buzz~
LIBRARY_AUTHOR = "Frank Barknecht <frank.barknecht@netcologne.de>"
LIBRARY_DESCRIPTION = "buzz~ generates a signal from a set of harmonically related partials."
LIBRARY_LICENSE = "see COPYRIGHT"
